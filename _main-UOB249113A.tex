...
\hypertarget{programming-in-r-1}{%
\chapter{Programming in R}\label{programming-in-r-1}}

\hypertarget{random-numbers-for-loops-and-r-1}{%
\section{Random Numbers, For Loops and R}\label{random-numbers-for-loops-and-r-1}}
...
\hypertarget{built-in-commands-1}{%
\subsection{Built in commands}\label{built-in-commands-1}}
...
\begin{verbatim}
##  [1] -0.11701298  0.58573653 -0.22781686  0.37061279  0.03636466 -0.19217910
##  [7] -0.90089698 -0.74827897 -0.20294241  0.14998011
\end{verbatim}
...
\hypertarget{good-coding-practices-1}{%
\section{Good Coding Practices}\label{good-coding-practices-1}}

In the past two labs, we've written code to solve different problems. In this lab, we're going to take a step back and think about what good R code does and doesn't look like.

\hypertarget{code-style-1}{%
\subsection{Code Style}\label{code-style-1}}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-49-4.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-49-5.pdf}
\end{example}
